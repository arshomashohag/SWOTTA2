...
if(isset($_POST['update_slider']))
   {
      ...
      $filepath = "images/slider/".$count.$filename;  
       ...
       $r = updateSlider($id, $head, $filepath, $filetmp);
                               ...
                               <div class="col-md-7">
                                  <div class="panel panel-info">
                                      ...
                                      <div class="panel-body">
                                          <?php 
                                          printf('<form action="sliderDetails.php?sid=%s" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">',$id);
                                          ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                              ...
                                              <div class="col-sm-9">
                                                  <button  type="submit" class="btn btn-success form-control" name="update_slider">Update Advertisement</button>
                                              </div>
                                        </div>
