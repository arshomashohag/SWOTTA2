<?php
    ...
    global $connection ;
	  ...
	  $queryLink="SELECT * from addimage where id='$id'";
                                              ...
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                    ...
                                                    <button type="button" data-dismiss="modal" class="btn btn-danger" id="confirm"  onclick=deleteAdvertisement(\'%s\')>Delete</button>
                                                 </div>
                                              </div>
                                            </div>
                                          </div>
