...
if(isset($_POST['update_gallery']))
   {
      ...
      $filepath = "images/gallery/".$count.$filename;  
       ...
       $r = updategallery($id, $head, $filepath, $filetmp);
                               ...
                               <div class="col-md-7">
                                  <div class="panel panel-info">
                                      <div class="panel-heading">
                                          <span class="contactHead"><h2 class="active">Edit Gallery </h2></span>
                                            
                                      </div>
                                      
                                      <div class="panel-body">
                                          <?php 
                                          printf('<form action="galleryDetails.php?gid=%s" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">',$id);
                                          ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                              ...
                                              <div class="col-sm-9">
                                                  <button  type="submit" class="btn btn-success form-control" name="update_gallery">Update Gallery</button>
                                              </div>
                                        </div>
