...
if(isset($_POST['update_content']))
   {
      ...
      $filepath = "images/contents/".$count.$filename;  
       ...
       $r = updateContentes($id, $title, $filepath, $filetmp, $article);
...
if(isset($_GET['id'])){
  ...
  $id=$_GET['id'];
	$contents = getAllcontentsDetails($id);
                               ...
                               <div class="col-md-7">
                                  <div class="panel panel-info">
                                      ...
                                      <div class="panel-body">
                                          <?php 
                                          printf('<form action="editContentsDetails.php?id=%s" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">',$id);
                                          ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                              ...
                                              <div class="col-sm-9">
                                                  <button  type="submit" class="btn btn-success form-control" name="update_content">Update Content</button>
                                              </div>
                                        </div>
