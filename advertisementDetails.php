...
if(isset($_POST['update_advertisement']))
   {
      $id=$_POST['contentid'];
      $head=$_POST['head'];
      $head = nl2br(htmlentities($head, ENT_QUOTES, 'UTF-8'));
      $filetmp = "";
      $filename = "";
      $filepath = "";
      ...
      $filepath = "images/add/".$count.$filename;  
       ...
       $r = updateAdvertisemnt($id, $head, $filepath, $filetmp);
                               ...
                               <div class="col-md-7">
                                  <div class="panel panel-info">
                                      <div class="panel-heading">
                                          <span class="contactHead"><h2 class="active">Edit Advertisement </h2></span>
                                            
                                      </div>
                                      
                                      <div class="panel-body">
                                          <?php 
                                          printf('<form action="advertisementDetails.php?aid=%s" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">',$id);
                                          ?>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <div class="col-sm-9">
                                                <textarea  name="head" type="text" class="form-control" id="inputtext"  rows="8" required><?php $breaks = array("<br />","<br>","<br/>");$body = str_ireplace($breaks, "\n", $head); echo $head;?></textarea>
                                              </div>
                                        </div>
                                         <div class="form-group">
                                              <div class="col-sm-3"></div>
                                              <div class="col-sm-9">
                                                  <button  type="submit" class="btn btn-success form-control" name="update_advertisement">Update Advertisement</button>
                                              </div>
                                        </div>
